# Weekly Executive Brief — Week Ending 2026-07-10
...
- **Data Quality Monitoring** — Red (**0 ↓ -8**) | Drivers: blocked 4d, scope changes 3/14d, stagnant 4d, deps 10 (critical) | Target: -153d
...
- **AI Program OS** — Red (**45 ↓ -4**) | Drivers: scope changes 2/14d | Target: -150d
...
- Dependencies: For critical path dependencies, align sequencing and escalation paths explicitly.
- Capacity: For near-term targets with declining confidence, choose: add capacity vs reduce surface area vs accept slip.

> Note: This brief is derived from scored operational signals. Root-cause validation may require qualitative follow-up with owners.